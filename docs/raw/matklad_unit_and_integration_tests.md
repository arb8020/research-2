...
If you enjoyed this post, you might like [*How to Test*](https://matklad.github.io/2021/05/31/how-to-test.html) as well. It goes further in the prescriptive direction, but, when writing it, I didn’t have the two dimensional purity-extent vocabulary yet.
...
Also, as a pitch for the [*How to Test*](https://matklad.github.io/2021/05/31/how-to-test.html) post, take a second to appreciate how simple the test is, considering that it tests an error-resilient, highly incremental compiler:)
